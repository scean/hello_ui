...
public class RequestXLAuthJob {
	 ...
	 *
	 * @param code
	 * @param authType        1 表示走伪授权流程 0 表示走真授权流程
	 * @param wap             0 表示PC版页面 1 表示移动版页面
	 * @param redirectUri     可以指定回调地址 可选
	 * @param invisible       1 表示 视为http调用 json格式返回 ，其他或不填则 302 跳转
	 * @param responseHandler 请求回调监听器
	 */
